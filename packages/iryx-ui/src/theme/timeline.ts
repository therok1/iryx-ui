...
export const timelineTheme = tv({
  ...
  compoundVariants: [
    { withIcon: true, size: 'sm', class: { marker: 'mt-[calc((1lh-1.5rem)/2)] size-6 [&_svg]:size-3' } },
    { withIcon: true, size: 'md', class: { marker: 'mt-[calc((1lh-1.75rem)/2)] size-7 [&_svg]:size-3.5' } },
