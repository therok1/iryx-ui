...
export const datePickerTheme = tv({
  slots: {
    ...
    presets: '-mx-3 -mt-3 flex gap-1 overflow-x-auto border-b border-border p-3 sm:mx-0 sm:-my-3 sm:ml-0 sm:flex-col sm:overflow-visible sm:border-r sm:border-b-0 sm:py-3 sm:pr-3 sm:pl-0',
